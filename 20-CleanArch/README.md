...
Este desafio Clean Architecture do curso Go Expert.

O propósito do projeto é construir uma aplicação considerando a organização de um projeto Go com Clean Architecture. Que consiste em uma aplicação de ordem de serviço. 

Sendo possível criar as ordens de serviço, informando o preço e a taxa do serviço, a aplicação receberá os dados e calculará o preço final de cada serviço. 
...
> gRPC
- _gRPC_ é um formato de comunicação que trabalha trafegando arquivos binários (_[Protocol Buffers](https://protobuf.dev)_)no formato proto 3. 
