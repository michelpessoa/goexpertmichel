...
func main() {
	...
	// A variável será utilizada em ambas as threads
	var i int64 = 0
	// RabbitMQ
	go func() {
		for {
			// E para não ter problemas de concorrência utiliza-se o
			// atomic para garantir o lock durante o uso da variável
			atomic.AddInt64(&i, 1)
